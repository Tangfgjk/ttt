...
class ImportService:
        ...
        return ImportBatchDetailOut(
            ...
            records=[
                ImportSourceRecordOut(
                    ...
                    normalized_question_id=item.normalized_question_id,
                    duplicate_candidate_count=duplicate_counts.get(item.id, 0),
    ...
    def _create_batch(self, *, data_source: DataSource, file_name: str) -> ImportBatch:
        batch = ImportBatch(
            data_source_id=data_source.id,
